...
CONST AUTHOR1_ROW       = 10     ' Background row in which to print AUTHOR string
CONST AUTHOR1_LENGTH    = 6      ' Length of AUTHOR string, in characters
CONST AUTHOR1_COLOR     = CS_WHITE   ' Color of AUTHOR string (and copyright year)

CONST AUTHOR2_ROW       = 11     ' Background row in which to print AUTHOR string
CONST AUTHOR2_LENGTH    = 8      ' Length of AUTHOR string, in characters
CONST AUTHOR2_COLOR     = CS_WHITE   ' Color of AUTHOR string (and copyright year)
...
PRINT AT SCREENPOS(4, 7) COLOR CS_GREEN, "with Minty fw"
...
PRINT AT TextCenterPos((AUTHOR1_LENGTH + 4), AUTHOR1_ROW) + 0, BG27 + AUTHOR1_COLOR
PRINT AT TextCenterPos((AUTHOR1_LENGTH + 4), AUTHOR1_ROW) + 1 COLOR AUTHOR1_COLOR,  "2024 AOtta"

PRINT AT TextCenterPos((AUTHOR2_LENGTH + 4), AUTHOR2_ROW) + 0, BG27 + AUTHOR2_COLOR
PRINT AT TextCenterPos((AUTHOR2_LENGTH + 4), AUTHOR2_ROW) + 1 COLOR AUTHOR2_COLOR,  "2025 gtortone"
